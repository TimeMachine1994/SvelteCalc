...
// Establish global variables for svelteCalc
define('DB_NAME_2', 'austlzji_svelteCalc');
define('DB_USER_2', 'austlzji_svelteCalcBot');
define('DB_PASSWORD_2', '9JcA&ekUq**cZ3');
define('DB_HOST_2', 'localhostt');
