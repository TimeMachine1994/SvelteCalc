    ...
    <div class="min-h-screen bg-gray-700 flex items-center justify-center">
     ...
     <div class="bg-gray-800 border-2 border-gray-900 shadow-2xl rounded-lg grid grid-cols-4 gap-2">
            ...
            <div>
                <div>
                    {#if livestreamAtFuneralHome !== false}
                        <button class="col-span-2 bg-gray-500 hover:bg-gray-400 rounded-full p-5 text-white text-center" on:click={() => selectPackage('Solo')}>Solo</button>
                    {/if}
                    <button class="col-span-2 bg-gray-500 hover:bg-gray-400 rounded-full p-5 text-white text-center" on:click={() => selectPackage('Anywhere')}>Anywhere</button>
                    <button class="col-span-2 bg-gray-500 hover:bg-gray-400 rounded-full p-5 text-white text-center" on:click={() => selectPackage('Legacy')}>Legacy</button>
                </div>
        ...
        <div class="col-span-2 bg-gray-500 rounded-full p-5 text-white text-center">
            ...
            Your Loved One's Custom Link <br>
            Tributestream.com/celebration_of_life_for_{urlFriendlyText} <br>
